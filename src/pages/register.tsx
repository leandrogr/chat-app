        ...
        <form action="" onSubmit={handleSubmit(onRegister)}>
          ...
          <div className="mt-4">
            <div className="mt-4">
              ...
              <input type="text" name="name" id="name" {...register("name")}  placeholder="Nome" className="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"/>
            ...
            <div className="mt-4">
              ...
              <input type="password" name="password" id="password" {...register("password")}  placeholder="Senha" className="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"/>
